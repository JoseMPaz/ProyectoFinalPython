...
"""
Carga la lista de productos con los datos del archivo csv, que tiene la informacion cargada separando sus atributos por comas
Parámetros: 
archivo de base de datos, por defecto se guarda un archivo llamado base_datos.csv
Retorna: 
Lista de productos
""" 
	...
	if os.path.exists (archivo):
		with open (archivo, 'r', newline = '') as base_datos:	
			...
			for producto in productos_csv:
				nombre, categoria, precio = producto[NOMBRE], producto[CATEGORIA], int(producto[PRECIO])
